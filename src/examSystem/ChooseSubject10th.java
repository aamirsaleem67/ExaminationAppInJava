...
public class ChooseSubject10th implements ActionListener{
        ...
        try{
            ...
            if(flag==true)
            {
                ...
                tabedpaneUser.f.dispose();
                  ...
                  m.create_frameMCQ();
                  m.ryt_answer(rytc);
                  m.FixClassandSubject("10th", subject);
